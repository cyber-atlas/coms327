...
//TODO copied the gen_monsters and am working on getting it to work with the description info
void gen_monsters2(dungeon *d)
{
  uint32_t i;
  npc *m;
  uint32_t room;
...
void npc_next_pos_rand(dungeon_t *d, npc *c, pair_t next)
{
  pair_t n;
  union {
    uint32_t i;
...
void npc_next_pos_line_of_sight(dungeon_t *d, npc *c, pair_t next)
{
  pair_t dir;
