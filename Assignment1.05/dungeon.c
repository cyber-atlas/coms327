...
void render_dungeon(dungeon_t *d){
  ...
  for (p[dim_y] = 0; p[dim_y] < DUNGEON_Y; p[dim_y]++) {
	...
	//This grabs the character from the iterator in the for loop above, and then adds the symbol that was being added anyways
...
//You can leave the distance map the same because you are rerendering each time in the pc file and that uses ncurses and updates for you
